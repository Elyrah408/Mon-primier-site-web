// let hexInput = document.getElementById("slc");
// let btn = document.querySelector("button");
// let deuInput = document.getElementById("deu");
// let rgbInput = document.getElementById("rgb");
// let tetInput = document.getElementById("tritanopie");
// let proInput = document.getElementById("ptn");
// let clean = document.getElementById("reset");
// let lev= document.getElementById("select");
...
//color picker
    ...
    sub_btn.addEventListener("click", ()=>{
     ...
     let rgbArr=[];
      ...
      //         // rgbInput.value =rgbArr[0]+","+rgbArr[1]+","+rgbArr[2];
      //         // deuInput.value =Math.abs(Math.round(finDeuValR))+","+Math.abs(Math.round(finDeuValG))+","+Math.abs(Math.round(finDeuValB));
      //         // tetInput.value =Math.abs(Math.round(fintetValR))+","+Math.abs(Math.round(fintetValG))+","+Math.abs(Math.round(fintetValB));
      //         // proInput.value =Math.abs(Math.round(fiproValR))+","+Math.abs(Math.round(fiproValG))+","+Math.abs(Math.round(fiproValB));
      ...
      //       document.getElementById("backdue").style.backgroundColor="rgb("+rdh+")";
      //       document.getElementById("backtit").style.backgroundColor="rgb("+rth+")";
      //       document.getElementById("backpro").style.backgroundColor="rgb("+rph+")";
